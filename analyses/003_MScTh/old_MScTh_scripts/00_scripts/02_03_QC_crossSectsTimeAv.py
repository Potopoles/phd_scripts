...
for count in counts:
	...
	plotOutDir = '../00_plots/02_QC_crossSections/03_timeAverage'
	if lat == None:
		plotName = 'QC_crossSection_hrs_12-15_timeAverage_lon_' + str(lon) + '.png'
	elif lon == None:
		plotName = 'QC_crossSection_hrs_12-15_timeAverage_lat_' + str(lat) + '.png'
	##### 1D PLOT #########

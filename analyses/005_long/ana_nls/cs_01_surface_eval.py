...
var_names = ['SLHFLX', 'SSHFLX', 'ENFLXNUSFC', 'LWNUSFC', 'SWNUSFC']
        ...
        '2,0':
        {
            ...
            'plot_dict':    {
                            'l1':[{'mem_key':era5,  'var_name':var_names[0],
                                  ...
                                  {'mem_key':era5,  'var_name':var_names[3],
                                   'color':colors[var_names[3]],
                                   'linestyle':linestyles[var_names[3]]},
                                  {'mem_key':era5,  'var_name':var_names[4],
                                   'color':colors[var_names[4]],
                                   'linestyle':linestyles[var_names[4]]},
                                   ],
                            },
            ...
            'plot_dict':    {
                            'l1':[{'mem_key':ctrl_3,    'var_name':var_names[0],
                                  ...
                                  {'mem_key':ctrl_3,  'var_name':var_names[2],
                                   'color':colors[var_names[2]],
                                   'linestyle':linestyles[var_names[2]]},
                                  {'mem_key':ctrl_3,  'var_name':var_names[3],
                                   'color':colors[var_names[3]],
                                   'linestyle':linestyles[var_names[3]]},
                                  {'mem_key':ctrl_3,  'var_name':var_names[4],
                                   'color':colors[var_names[4]],
                                   'linestyle':linestyles[var_names[4]]},
                                   ],
                            },
            ...
            'plot_dict':    {
                            'l1':[{'mem_key':ctrl_12,    'var_name':var_names[0],
                                  ...
                                  {'mem_key':ctrl_12,  'var_name':var_names[2],
                                   'color':colors[var_names[2]],
                                   'linestyle':linestyles[var_names[2]]},
                                  {'mem_key':ctrl_12,  'var_name':var_names[3],
                                   'color':colors[var_names[3]],
                                   'linestyle':linestyles[var_names[3]]},
                                  {'mem_key':ctrl_12,  'var_name':var_names[4],
                                   'color':colors[var_names[4]],
                                   'linestyle':linestyles[var_names[4]]},
                                   ],
                            },
            ...
            'plot_dict':    {
                            'l1':[{'mem_key':mpi,    'var_name':var_names[0],
                                  ...
                                  {'mem_key':mpi,  'var_name':var_names[2],
                                   'color':colors[var_names[2]],
                                   'linestyle':linestyles[var_names[2]]},
                                  {'mem_key':mpi,  'var_name':var_names[3],
                                   'color':colors[var_names[3]],
                                   'linestyle':linestyles[var_names[3]]},
                                  {'mem_key':mpi,  'var_name':var_names[4],
                                   'color':colors[var_names[4]],
                                   'linestyle':linestyles[var_names[4]]},
                                   ],
                            },
            'legend_for':   [{'mem_key':mpi,  'var_name':var_names[3]},
                             {'mem_key':mpi,  'var_name':var_names[4]},
                            ],
        },
            ...
            'plot_dict':    {
                            'l1':[{'mem_key':{'diff':[ctrl_3,eval]},  'var_name':var_names[0],
                                  ...
                                  {'mem_key':{'diff':[ctrl_3,eval]},  'var_name':var_names[2],
                                   'color':colors[var_names[2]],
                                   'linestyle':linestyles[var_names[2]]},
                                  {'mem_key':{'diff':[ctrl_3,eval]},  'var_name':var_names[3],
                                   'color':colors[var_names[3]],
                                   'linestyle':linestyles[var_names[3]]},
                                  {'mem_key':{'diff':[ctrl_3,eval]},  'var_name':var_names[4],
                                   'color':colors[var_names[4]],
                                   'linestyle':linestyles[var_names[4]]},
                                   ],
                            },
            ...
            'plot_dict':    {
                            'l1':[{'mem_key':{'diff':[ctrl_12,eval]},  'var_name':var_names[0],
                                  ...
                                  {'mem_key':{'diff':[ctrl_12,eval]},  'var_name':var_names[2],
                                   'color':colors[var_names[2]],
                                   'linestyle':linestyles[var_names[2]]},
                                  {'mem_key':{'diff':[ctrl_12,eval]},  'var_name':var_names[3],
                                   'color':colors[var_names[3]],
                                   'linestyle':linestyles[var_names[3]]},
                                  {'mem_key':{'diff':[ctrl_12,eval]},  'var_name':var_names[4],
                                   'color':colors[var_names[4]],
                                   'linestyle':linestyles[var_names[4]]},
                                   ],
                            },
            ...
            'plot_dict':    {
                            'l1':[{'mem_key':{'diff':[mpi,eval]},  'var_name':var_names[0],
                                  ...
                                  {'mem_key':{'diff':[mpi,eval]},  'var_name':var_names[2],
                                   'color':colors[var_names[2]],
                                   'linestyle':linestyles[var_names[2]]},
                                  {'mem_key':{'diff':[mpi,eval]},  'var_name':var_names[3],
                                   'color':colors[var_names[3]],
                                   'linestyle':linestyles[var_names[3]]},
                                  {'mem_key':{'diff':[mpi,eval]},  'var_name':var_names[4],
                                   'color':colors[var_names[4]],
                                   'linestyle':linestyles[var_names[4]]},
                                   ],
                            },

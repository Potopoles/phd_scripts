...
##############################################################################
for var_name in ['LWDIVATM','CLWDIVATM']:
    min = 100
    max = 260
    delta = 10
    nlp['cmaps'     ]['abs' ][var_name] = 'gnuplot2' 
    ...
    range = 20
    delta = 4
    nlp['cmaps'     ]['diff'][var_name] = 'RdBu' 
    nlp['levels'    ]['diff'][var_name] = np.arange(-range+delta/2,range,delta)
    nlp['cb_ticks'  ]['diff'][var_name] = nlp['levels']['diff'][var_name][::2]

##############################################################################
for var_name in ['CRELWDIVATM']:
    min = -100
    max = 40
    delta = 10
    nlp['cmaps'     ]['abs' ][var_name] = 'gnuplot2' 
